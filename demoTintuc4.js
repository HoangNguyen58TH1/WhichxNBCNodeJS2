...
var idtheloai;
const articlesArray = [];
for (let i = 0; i < articles3.length; i++) {
  var News = category.classify(articles3[i].title);
  console.log(articles3[i].title);
  ...
  totalTheloai.push(idtheloai);
  console.log('totalTheloai: ', totalTheloai);
